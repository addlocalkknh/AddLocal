...
import com.add.local.model.ShopKeeper;

@Service
public class UserOperations implements Serializable,Runnable {

	private static final long serialVersionUID = 100L;
	public static final String DIR_PATH="C:/Partition/Craz/";
	...
	//For time being hard coded. Will be revisited
	String name = "Kumar";
	String email = "mkumar.drait@gmail.com";
	String password = "secret";
	String shopname ="testShop";

	{
		try{
			File f = new File(DIR_PATH+"Objects.txt");
			if(f.length()!= 0){
	...
	public void AddUser(){
		...
		if (flag == true){
			...
			try{
				...
				FileOutputStream fos = new FileOutputStream(DIR_PATH+"Objects.txt");
